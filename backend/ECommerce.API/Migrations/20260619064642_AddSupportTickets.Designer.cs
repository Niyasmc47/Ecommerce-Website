...
namespace ECommerce.API.Migrations
{
    ...
    [Migration("20260619064642_AddSupportTickets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.API.Models.ReturnRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.Product", b =>
                {
                    ...
                    b.HasOne("ECommerce.API.Models.Seller", "Seller")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ECommerce.API.Models.Seller", b =>
                {
                    b.HasOne("ECommerce.API.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("ECommerce.API.Models.Seller", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerce.API.Models.SupportMessage", b =>
                {
                    b.HasOne("ECommerce.API.Models.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ECommerce.API.Models.SupportTicket", "Ticket")
                        .WithMany("Messages")
