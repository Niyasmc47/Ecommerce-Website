    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <header className="px-8 py-6 flex items-center justify-between bg-white border-b border-slate-200">
        ...
        <div className="flex items-center gap-4 text-slate-500">
          <span className="material-symbols-outlined cursor-pointer hover:text-slate-800 transition-colors">language</span>
          <span className="material-symbols-outlined cursor-pointer hover:text-slate-800 transition-colors">help_outline</span>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-[440px] bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-10 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#" className="text-sm text-[#0D47A1] font-medium hover:underline">Forgot Password?</a>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 text-center text-sm text-slate-600">
            Don't have an account? <Link to="/register" className="text-[#0D47A1] font-bold hover:underline">Create an account</Link>
          </div>
        </div>
      </main>
      ...
      <footer className="px-8 py-6 border-t border-slate-200 bg-white flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-sm text-slate-600 font-medium">
          ...
          <a href="#" className="hover:text-slate-900 underline decoration-slate-300 underline-offset-4">Terms of Service</a>
          <a href="#" className="hover:text-slate-900 underline decoration-slate-300 underline-offset-4">Security Standards</a>
          <a href="#" className="hover:text-slate-900 underline decoration-slate-300 underline-offset-4">Contact Support</a>
        </div>
      </footer>
    </div>
  );
